...
from [OpenStreetMap](https://www.openstreetmap.org), you can compute accidents per street with a
[Scikit-Learn](https://scikit-learn.org/stable/)–style pipeline called the `Urban Pipeline`—in under 15 lines of code.
...
UrbanMapper Community is the open, community-maintained fork of UrbanMapper. We keep alignment with upstream releases
whenever possible while extending the toolkit with openly discussed features and a public roadmap.

If you want to shape the future of UrbanMapper, visit the [Community Hub](../community-hub.md).
...
More urban layers will be added in the future. Suggestions? Open an issue or pull request on our
[GitHub repository](https://github.com/simonprovost/UrbanMapper-Community/issues).
...
- [Installation](installation.md): Install UrbanMapper Community.
- [Getting Started Step by Step](quick-start_step_by_step.md): Create your first analysis step by step.
- [Getting Started with Pipeline](quick-start_pipeline.md): Build your first pipeline-based analysis.
- [Interactive Examples](../EXAMPLES.md): Explore notebooks and runnable case studies.
- [API Reference](../api/index.md): Complete API documentation.
- [Urban Mapper MCP ("Control Your Urban Analysis with LLMs")](https://mcpstack.readthedocs.io/en/latest/tutorials/urbanmapper-jupyter/)
